...
(function (global, factory) {
      ...
      do {
        if (sj <= sk) {
          if (intersects(j._, c._)) {
            if (sj + a._.r + b._.r > distance1(j, b)) a = j;
            else b = j;
          ...
          if (intersects(k._, c._)) {
            if (distance1(a, k) > sk + a._.r + b._.r) a = k;
            else b = k;
            (a.next = b), (b.previous = a), --i;
            continue pack;
          }
  ...
  function continuous(deinterpolate, reinterpolate) {
    ...
    scale.range = function (_) {
      return arguments.length
        ? ((range$$1 = slice$4.call(_)), rescale())
        : range$$1.slice();
    };
  ...
  function quantize$1() {
    ...
    scale.range = function (_) {
      return arguments.length
        ? ((n = (range$$1 = slice$4.call(_)).length - 1), rescale())
        : range$$1.slice();
    };
  ...
  var stack = function () {
    ...
    stack.keys = function (_) {
      return arguments.length
        ? ((keys = typeof _ === "function" ? _ : constant$10(slice$5.call(_))),
          stack)
        : keys;
    };
